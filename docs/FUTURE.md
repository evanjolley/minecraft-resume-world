...
are visible in hand, slabs and stairs with real collision, shift-click, a 355-block palette on a paged texture atlas, slabs and stairs for 28 material families with real sub-voxel
collision,
